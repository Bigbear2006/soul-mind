...
def get_full_profile_text(client: Client) -> tuple[str, list[str], str]:
    ...
    if client.subscription_is_active():
        ...
        return (
            ...
            content,
            client.genderize(
                'Ты {gender:прочитал,прочитала}. {gender:Почувствовал,Почувствовала}. {gender:Узнал,Узнала} себя.\n'
                ...
                '\n'
                'Но ты уже {gender:начал,начала}.\n'
                'А это значит — ты {gender:готов,готова}.\n'
                '\n'
