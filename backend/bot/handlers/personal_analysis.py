...
from bot.templates.career_and_finance import get_career_and_finance_text, get_career_and_finance_intro
from bot.templates.destiny_mystery import get_destiny_mystery_intro, get_destiny_mystery_text
from bot.templates.full_profile import get_full_profile_text, get_full_profile_intro
from bot.templates.love_code import get_love_code_text, get_love_code_intro
from bot.templates.personal_analysis import get_personal_analysis_intro
from bot.templates.superpower import get_superpower_text, get_superpower_intro
