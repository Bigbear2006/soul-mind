        ...
        if client.subscription_plan == SubscriptionPlans.STANDARD:
            await answer_func(
                client.genderize(
                    '🧩 Практики для роста\n'
                    'Ты уже в игре.\n'
                    'Каждый день — одно действие для фокуса + 5 астробаллов.\n'
                    'Каждый месяц — один челлендж, который собирает тебя по частям + 80 астробаллов.\n\n'
            ...
            await answer_func(
                client.genderize(
                    ...
                    'Астробаллы бонусом за каждое ежедневное задание +5, '
                    'за два челленджа в месяц + 160 — всё остальное только для души.\n\n'
